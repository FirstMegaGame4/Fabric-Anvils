...
import fr.firstmegagame4.fabricanvils.anvil.FragileMetalAnvil;
...
public class GoldenAnvil extends FragileMetalAnvil {
    ...
    public GoldenAnvil() {
        super(FabricBlockSettings.create().mapColor(MapColor.GOLD).sounds(BlockSoundGroup.METAL).hardness(4.0F));
    }
